	...
	if (props.search) {
		...
		if (typeof props.children === 'string') {
			children = _react2.default.createElement(
				...
				{ className: props.className, matchClass: null, matchElement: 'mark', search: props.search, title: props.children },
				props.children
			);
		} else {
				...
				return nodeArr.map(function (element) {
					...
					if (typeof element === 'string') {
						newElement = _react2.default.createElement(
							_reactHighlighter2.default,
							{ key: element, className: props.className, matchClass: null, matchElement: 'mark', search: props.search, title: element },
							element
						);
					} else {
						newElement = element;
