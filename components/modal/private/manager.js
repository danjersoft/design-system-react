define(['exports', 'react', 'create-react-class', 'react-dom', '../../button', '../../icon', '../../../utilities/event', 'react-modal'], function (exports, _react, _createReactClass, _reactDom, _button, _icon, _event, _reactModal) {
	'use strict';
		...
		getModal: function getModal() {
			return (
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'slds-modal__container', onClick: function onClick(e) {
